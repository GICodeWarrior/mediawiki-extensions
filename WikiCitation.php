...
/**
 * Array for defining allowable referencing styles, and setting a default.
 *
 * Array of recognized children of WCCitation, keyed to magic words used to
 * invoke that style. For example, the magic word 'wcChicago'
 * ('Chicago' in English) is keyed to the class 'WCChicagoCitation'
 *
