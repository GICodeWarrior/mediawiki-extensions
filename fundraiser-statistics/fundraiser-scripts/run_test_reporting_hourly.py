...
if len(sys.argv) > 1:
	...
	header_logs = ['hour', 'campaign','banner','landing_page','impressions','views','donations','amount','click_rate', \
	'donations per 100000 impressions','amount per 100000 impressions','donations per 100000 views','amount per 100000 views']
	...
	header_logs = ['campaign','banner','landing_page','impressions','views','donations','amount','click_rate', \
	'donations per 100000 impressions','amount per 100000 impressions','donations per 100000 views','amount per 100000 views']
