...
$messages['de'] = array(
		...
		"fptc-invalid-attribute" => "Das eingegebene Attribut ist ung&uuml;ltig.",
		"fptc-insufficient-rights-for-maintenance" => "Um diese Seite sehen zu k&ouml;nnen m&uuml;ssen Sie als Systemadministrator angemeldet sein.",
		"fptc-refresh-frequent-patterns" => "Aktualisierung der Daten",
		"fptc-refreshed-frequent-patterns" => "Regeln f&uuml;r frequent pattern neu generiert.",
