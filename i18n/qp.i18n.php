...
To save a poll, submit it while not answering to any proposal questions.',
	...
	'qp_error_invalid_proposal_name' => 'Proposal name cannot be numeric.',
...
* $3 is the poll ID of the poll, which this erroneous poll depends on.',
	...
	'qp_error_invalid_proposal_name' => 'Proposal name should not be numeric to avoid possible reference clash with proposal ids, which are integer numbers.',
...
$messages['ru'] = array(
	...
	'qp_error_invalid_proposal_name' => 'Имя строки вопроса не может быть числом.',
