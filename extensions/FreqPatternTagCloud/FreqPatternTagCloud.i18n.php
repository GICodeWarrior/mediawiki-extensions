...
$messages['en'] = array(
		...
		"InsufficientRightsForMaintenance" => "You have to log in as system administrator to view this page.",
		"RefreshFrequentPatterns" => "Refresh Data",
		"RefreshedFrequentPatterns" => "Frequent pattern rules refreshed.",
...
$messages['de'] = array(
		...
		"freqpatterntagcloud" => "Frequent Pattern Tag Cloud",
		"freqpatterntagcloudmaintenance" => "Frequent Pattern Tag Cloud Maintenance",
		"InvalidAttribute" => "Das eingegebene Attribut ist ung&uuml;ltig.",
		"InsufficientRightsForMaintenance" => "Um diese Seite sehen zu k&ouml;nnen m&uuml;ssen Sie als Systemadministrator angemeldet sein.",
		"RefreshFrequentPatterns" => "Aktualisierung der Daten",
		"RefreshedFrequentPatterns" => "Regeln f&uuml;r frequent pattern neu generiert.",
