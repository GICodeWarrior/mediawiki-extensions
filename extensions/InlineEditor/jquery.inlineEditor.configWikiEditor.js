/**
 * Configuration file for the wikiEditor Toolbar.
 * @todo: FIXME: make the WikiEditor toolbar configuration portable and use that instead
 * of this file!!!
 */
 
( function( $ ) { $.inlineEditor.configWikiEditor = {

	/**
	 * Configuration for WikiEditor.
	 */
	...
	$( 'textarea' ).wikiEditor( 'addModule', { 'toolbar': {
	// Main section
                'main': {
                'type': 'toolbar',
                'groups': {
