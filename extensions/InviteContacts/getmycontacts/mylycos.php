<?php
/**
 * Lycos contact importing script -- csv version
 */
...
$path_to_cookie = realpath( 'lycoscookie.txt' );
...
// Step 2
$postal_data = 'm_PR=27&m_CBURL=http://mail.lycos.com:80/lycos/Index.lycos&m_U=' . $username . '&m_P=' . $password . '&m_AS=1&x=23&y=8';
$url = 'http://ldbreg.lycos.com/cgi-bin/mayaLogin?m_PR=27';
