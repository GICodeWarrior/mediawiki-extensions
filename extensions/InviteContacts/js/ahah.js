function submit( FILE, METHOD ) {
	...
	for( var i = 0; i < num; i++ ) {
		var key = document.emailform.elements[i].name;
		var value = document.emailform.elements[i].value;
		var type = document.emailform.elements[i].type;
...
function ahah( url, target, delay, method, parameters ) {
	if( method == undefined ) {
		document.getElementById(target).innerHTML = '<p class="contacts-loading"><img src="' + wgScriptPath + '/skins/common/images/spinner.gif" width="16" height="16" alt="wait" border="0" /></p>';
