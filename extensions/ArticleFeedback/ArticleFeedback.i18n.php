...
$messages['ja'] = array(
	...
	'articlefeedback-pitch-join-message' => 'アカウントを作成できることをご存じですか。アカウントを作成することで、自分自身の編集を振り返ることが容易になり、議論に参加しやすくなり、コミュニティの一員にもなれます。',
...
$messages['lb'] = array(
	...
	'articlefeedback-pitch-join-message' => 'Wosst Dir datt Dir e Benotzerkont opmaache kënnt? E Benotzerkont hëlleft Iech Är Ännerungen am Aen ze behalen, Iech méi einfach un Diskussiounen ze bedeelegen an en Deel vun der Gemeinschaft ze sinn.',
...
$messages['sah'] = array(
	...
	'articlefeedback-pitch-join-message' => 'Манна бэлиэтэнэр кыах баарын билэҕин дуо? Бэлиэтэннэххинэ бэйэҥ көннөрүүлэргин кэлин көрөр, ырытыыларга кыттар уонна маннааҕы дьон-сэргэ сорҕото буолар кыахтаныаҥ.',
