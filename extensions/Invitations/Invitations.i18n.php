...
$messages['br'] = array(
	...
	'invitations-invitedlist-description' => "Gallout a rit ober gant elfennoù da-heul ar meziant pediñ hepken.
Evit merañ ar pedadennoù evit un elfenn hiniennel, klikit war hec'h anv.",
	...
	'invitations-uninvitedlist-description' => "N'oc'h ket aotreet d'ober gant elfennoù ar programm pediñ hepken.",
	'invitations-uninvitedlist-none' => "Evit ar mare n'eus bet merket elfenn veziantel ebet all gant ar pediñ hepken",
	...
	'invitations-feature-noneleft' => "Implijet hoc'h eus o holl pedadennoù aotreet evit an arc'hweladur-mañ",
	'invitations-feature-noneyet' => "N'ho peus ket resevet ho pedadennoù evit an arc'hweladur-mañ.",
	'invitations-feature-notallowed' => "N'oc'h ket aotreet da implijout <i>$1</i>.",
 ...
 */
$messages['ml'] = array(
	'invite-logpage' => 'ക്ഷണത്തിന്റെ പ്രവർത്തനരേഖ',
	'invite-logpagetext' => 'വിവിധ സോഫ്റ്റ്‌വെയർ സവിശേഷതകൾ പരീക്ഷിക്കുവാൻ ഉപയോക്താക്കൾ അന്യോന്യം ക്ഷണിക്കുന്നതിന്റെ പ്രവർത്തന രേഖയാണിത്.',
	'invite-logentry' => '<i>$2</i> എന്ന സോഫ്റ്റ്‌വെയർ സവിശേഷത ഉപയോഗിക്കുവാൻ  $1നെ ക്ഷണിച്ചു.',
	'invitations' => 'സോഫ്റ്റ്‌വെയർ സവിശേഷത പരീക്ഷിക്കുവാനുള്ള ക്ഷണപത്രികകൾ പരിപാലിക്കുക',
	'invitations-invitedlist-description' => 'ക്ഷണത്തിലൂടെ മാത്രം പരീക്ഷിക്കുവാൻ സാധിക്കുന്ന സോഫ്റ്റ്‌വെയർ സവിശേഷതകളിൽ,  താഴെ പ്രദർശിപ്പിച്ചിരിക്കുന്നവ‍ താങ്കൾക്ക് പരീക്ഷിക്കാം. ഒരു പ്രത്യേക സവിശേഷതയ്ക്കുള്ള ക്ഷണപത്രിക പരിപാലിക്കാൻ, പ്രസ്തുത പേരിൽ ഞെക്കുക.',
	'invitations-invitedlist-none' => "'''ക്ഷണത്തിലൂടെ മാത്രം പരീക്ഷിക്കുവാൻ സാധിക്കുന്ന സോഫ്റ്റ്‌വെയർ സവിശേഷത'''കൾ ഉപയോഗിക്കുവാൻ താങ്കൾ ക്ഷണിക്കപ്പെട്ടിട്ടില്ല.",
	'invitations-pagetitle' => 'ക്ഷണത്തിലൂടെ മാത്രം ഉപയോഗിക്കുവാൻ സാധിക്കുന്ന സോഫ്റ്റ്‌വെയർ സവിശേഷതകൾ',
	'invitations-uninvitedlist-description' => "മറ്റ് '''ക്ഷണത്തിലൂടെ മാത്രം പരീക്ഷിക്കുവാൻ സാധിക്കുന്ന സോഫ്റ്റ്‌വെയർ സവിശേഷതകൾ''' ഉപയോഗിക്കാനുള്ള അനുമതി  താങ്കൾക്കില്ല.",
	'invitations-uninvitedlist-none' => "നിലവിൽ മറ്റു സോഫ്റ്റ്‌വെയർ സവിശേഷതകൾ ഒന്നും '''ക്ഷണത്തിലൂടെ മാത്രം പരീക്ഷിക്കുവാൻ സാധിക്കുന്ന സോഫ്റ്റ്‌വെയർ സവിശേഷത''' ആയി രേഖപ്പെടുത്തിയിട്ടില്ല.",
	'invitations-feature-pagetitle' => 'ക്ഷണപത്രിക പരിപാലനം -  $1',
	'invitations-feature-access' => 'താങ്കൾ‍ക്ക് നിലവിൽ <i>$1</i> ഉപയോഗിക്കാനുള്ള അനുമതിയുണ്ട്.',
	'invitations-feature-numleft' => 'ബാക്കിയുള്ള $2 ക്ഷണപത്രികകളിൽ താങ്കൾക്ക് ഇപ്പോഴും  <b>$1</b> എണ്ണമുണ്ട്.',
	'invitations-feature-noneleft' => 'ഈ സവിശേഷതയുടെ ലഭ്യമായ ക്ഷണപത്രികകളെല്ലാം താങ്കൾ ഉപയോഗിച്ചു കഴിഞ്ഞു.',
	'invitations-feature-noneyet' => 'ഈ സവിശേഷതയുടെ താങ്കൾക്ക് വരേണ്ട ക്ഷണപത്രിക താങ്കൾക്ക് ലഭിച്ചിട്ടില്ല.',
	'invitations-feature-notallowed' => 'താങ്കൾക്ക്  <i>$1</i> ഉപയോഗിക്കാനുള്ള അനുമതി ഇല്ല.',
	'invitations-inviteform-title' => '$1 ഉപയോഗിക്കുവാൻ വേണ്ടി ഉപയോക്താവിനെ ക്ഷണിക്കുക',
	'invitations-inviteform-username' => 'ക്ഷണിക്കപ്പെടേണ്ട ഉപയോക്താവ്',
	'invitations-inviteform-submit' => 'ക്ഷണിക്കുക',
	'invitations-error-baduser' => 'താങ്കൾ തിരഞ്ഞെടുത്ത ഉപയോക്തൃനാമം നിലവിലുള്ളതായി കാണുന്നില്ല.',
	'invitations-error-alreadyinvited' => 'താങ്കൾ തിരഞ്ഞെടുത്ത ഉപയോക്താവിനു ഇപ്പോൾ തന്നെ ഈ സവിശേഷത ലഭ്യമാണ്‌.',
	'invitations-invite-success' => 'ഈ സവിശേഷത ഉപയോഗിക്കുവാൻ താങ്കൾ $1നെ വിജയകരമായി ക്ഷണിച്ചിരിക്കുന്നു!',
);
