...
error_log('hi');
	...
	protected function executeNewForm() {
		...
		if(!$params['revid']) {
		    $params['revid'] = ApiArticleFeedbackUtils::getRevisionId($params['pageid']);
		}
	...
	protected function executeFetchRatings() {
		$params        = $this->extractRequestParams();
		$result        = $this->getResult();
		$revisionLimit = ApiArticleFeedbackUtils::getRevisionId( $params['pageid'] );
		$bucket        = $this->getBucket();
	...
	# Deprecated, alreadly, as we don't really care about this anymore,
	# and just insert a new row every time.
	...
	public function getVersion() {
		return __CLASS__ . ': $Id: ApiQueryArticleFeedback.php 100806 2011-10-26 14:19:13Z catrope $';
	}
}
