	...
	protected static $modules = array(
		'ext.articleFeedback' => array(
			...
			'messages' => array(
				...
				'articlefeedback-field-unbiased-label',
				'articlefeedback-field-unbiased-tip',
				'articlefeedback-field-wellwritten-label',
				'articlefeedback-field-wellwritten-tip',
				'articlefeedback-pitch-takesurvey-title',
				'articlefeedback-pitch-takesurvey-message',
				'articlefeedback-pitch-takesurvey-action',
				'articlefeedback-pitch-createaccount-title',
				'articlefeedback-pitch-createaccount-message',
				'articlefeedback-pitch-createaccount-action',
				'articlefeedback-pitch-makefirstedit-title',
				'articlefeedback-pitch-makefirstedit-message',
				'articlefeedback-pitch-makefirstedit-action',
			),
			'dependencies' => array(
