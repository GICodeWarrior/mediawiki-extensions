...
final class AdManagerHooks {
	...
	//Recursively walks through tree array. Creates array containing each input's level. (array_walk_recursive doesn't like when the value is an array)
	//A lower count indicates a closer ancestor to the page, that is supercategories are assigned higher numbers than subcategories
	...
	public static function SkinBuildSidebar( $skin, &$sidebar ) {
		global $wgOut, $wgDBprefix, $wgTitle, $wgAdManagerService, $wgAdManagerCode;
...
EOT
		...
		foreach ( $thisPageAdZones as $thisPageAdZone ) {			
			$adNumber++;
			//Allows admins to use any ad service or inclusion code they desire by inserting in LocalSettings
