-- MySQL version of the database schema for the WEP extension.
-- Licence: GNU GPL v3+
-- Author: Jeroen De Dauw < jeroendedauw@gmail.com >

-- Organizations, ie universities
CREATE TABLE IF NOT EXISTS /*_*/wep_orgs (
...
CREATE TABLE IF NOT EXISTS /*_*/wep_courses (
...
CREATE INDEX /*i*/wep_course_org_id ON /*_*/wep_courses (course_org_id);
CREATE INDEX /*i*/wep_course_name ON /*_*/wep_courses (course_name);
CREATE INDEX /*i*/wep_course_year ON /*_*/wep_courses (course_year);

-- Students
CREATE TABLE IF NOT EXISTS /*_*/wep_students (
  student_id                 INT unsigned        NOT NULL auto_increment PRIMARY KEY,
  student_user_id            INT unsigned        NOT NULL,
) /*$wgDBTableOptions*/;

CREATE INDEX /*i*/wep_students_user_id ON /*_*/wep_students (student_user_id);
...
CREATE INDEX /*i*/wep_mentors_user_id ON /*_*/wep_students (mentor_user_id);