var uniqueVisitors = { 
	...
	plotVar: {},
	apiCalls: {
		uniqueVisitors: "../wiki/api.php?action=analytics&metric=comscoreuniquevisitors&startmonth=2008-04&endmonth=2011-05&selectregions=AS,EU,LA,MA,NA,US,W&reportlanguage=en&format=json",
		offlineEstimate: "../wiki/api.php?action=analytics&metric=estimateoffline&startmonth=2004-08&endmonth=2011-05&format=json"
	},
