<?php
/**
 * Internationalisation file for the extension ZeroRatedMobileAccess
 *
 * @file
 * @ingroup Extensions
...
$messages['en'] = array (
	...
	'zero-rated-mobile-access-banner-text' => 'Free Wikipedia from $1',
 ...
 */
$messages['de'] = array(
	'zero-rated-mobile-access-desc' => 'Stellt Mobilfunkanbietern Funktionen bereit, mit denen diese kostenfreien Zugriff auf das Wiki ermöglichen können',
...
$messages['de-formal'] = array(
	'zero-rated-mobile-access-home-page-selection-text' => 'Oder besuchen Sie die Startseite in der folgenden Sprache:',
);
 ...
 */
$messages['dsb'] = array(
	'zero-rated-mobile-access-desc' => 'Staja póbitowarjam mobilneje telefonije funkcije k dispoziciji, kótarež zmóžnjaju dermotny pśistup',
 ...
 */
$messages['fr'] = array(
	'zero-rated-mobile-access-desc' => 'Fournit les fonctionnalités pour les fournisseurs de mobile qui proposent un accès libre',
 ...
 */
$messages['hsb'] = array(
	'zero-rated-mobile-access-desc' => 'Staja poskićowarjam mobilneho škričkowanja funkcije k dispoziciji, kotrež darmotny přistup zmóžnjeja',
	...
	'zero-rated-mobile-access-banner-text-data-charges-no' => 'Ně',
	'zero-rated-mobile-access-click-to-view-image' => 'Klikń tu, zo by wobraz wot "$1" widźał...',
);
 ...
 */
$messages['ia'] = array(
	'zero-rated-mobile-access-desc' => 'Provide functionalitate pro fornitores mobile que offere accesso libere',
 ...
 */
$messages['mk'] = array(
	'zero-rated-mobile-access-desc' => 'Овозможува функции за мобилни оператори што даваат бесплатен пристап',
 ...
 */
$messages['te'] = array(
	'zero-rated-mobile-access-search' => 'వెతుకు',
