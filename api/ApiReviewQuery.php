 ...
 * ReviewsDBObject deriving class.
 *
 * @since 0.1
 *
 * @file ApiReviewQuery.php
 * @ingroup Reviews
 * @ingroup API
 *
 * @licence GNU GPL v3+
 ...
 */
abstract class ApiReviewQuery extends ApiQueryBase {

	/**
	 * Returns the class specific info.
	 * * class: name of the ReviewsDBObject deriving class (ie Contest)
	...
	/**
	 * Returns the name of the ReviewsDBObject deriving class.
	 * 
	 * @since 0.1
	 * 
	 * @return string
	...
	protected function getParams() {
		...
		if ( $starPropPosition !== false ) {
			...
			$class = $this->getClass();
			$params['props'] = array_merge( $params['props'], $class::getFieldNames() );
		}
	 ...
	 *
	 * @return array of ReviewsDBObject
	 */
	protected function getResults( array $params, array $conditions ) {
		...
		return $this->getClass()->select(
			...
			array(
				...
				'ORDER BY' => $class::getPrefixedField( 'id' ) . ' ASC'
			)
		);
	}
	 ...
	 * @param array $results
	 */
	protected function addResults( array $params, array /* of ReviewsDBObject */ $results ) {
	...
	public function getAllowedParams() {
		...
		$params = array (
			'props' => array(
				ApiBase::PARAM_TYPE => array_merge( $class::getFieldNames(), array( '*' ) ),
		...
		return array_merge( $class::getAPIParams(), $params );
	}
	...
	public function getParamDescription() {
		...
		$class = $this->getClass();
		return array_merge( $class::getFieldDescriptions(), $descs );
	}
