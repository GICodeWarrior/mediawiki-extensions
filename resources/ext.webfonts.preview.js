...
jQuery( function( $ ) {
	...
	var showPreview = function( ) {
		...
		$previewBox.css( 'font-size', parseInt( $( 'select#webfonts-size-chooser' ).val ( ) ) );
	...
	$( 'select#webfonts-font-chooser' ).change( function () {
		showPreview();
	} );

	$( 'select#webfonts-size-chooser' ).change( function () {
		showPreview();
	} );
